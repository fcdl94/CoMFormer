...
base=output_inc
cont_args="CONT.BASE_CLS 15 CONT.INC_CLS 1 CONT.MODE disjoint"
task=voc_15-5-dis
#cont_args="CONT.BASE_CLS 15 CONT.INC_CLS 1 CONT.MODE overlap"
#task=voc_15-5-ov
...
python train_inc.py --num-gpus 2 --config-file ${cfg_file} ${comm_args} ${inc_args} NAME ${name}_UCE_UKD_10_fix CONT.DIST.KD_WEIGHT 10. CONT.DIST.UKD True CONT.DIST.UCE True
python train_inc.py --num-gpus 2 --config-file ${cfg_file} ${comm_args} ${inc_args} NAME ${name}_UCE_UKD_100_fix CONT.DIST.KD_WEIGHT 100. CONT.DIST.UKD True CONT.DIST.UCE True
python train_inc.py --num-gpus 2 --config-file ${cfg_file} ${comm_args} ${inc_args} NAME ${name}_UCE_UKD_20_fix CONT.DIST.KD_WEIGHT 20. CONT.DIST.UKD True CONT.DIST.UCE True
python train_inc.py --num-gpus 2 --config-file ${cfg_file} ${comm_args} ${inc_args} NAME ${name}_UCE_UKD_200_fix CONT.DIST.KD_WEIGHT 200. CONT.DIST.UKD True CONT.DIST.UCE True
