...
cfg_file=configs/ade20k/panoptic-segmentation/continual.yaml
base=ade_ps
...
#python train_inc.py --num-gpus 2 --config-file ${cfg_file} ${comm_args} ${inc_args} NAME ${name}_PSEUDO_T2_KD10Rew CONT.DIST.PSEUDO True CONT.DIST.PSEUDO_TYPE 1 CONT.DIST.KD_WEIGHT 10.0 CONT.DIST.KD_REW True
#
#for t in 2 3 4 5; do
